...
private function pgPrivate():void
   ...
   {
     if((isset($_SESSION['user_id'])) && (isset($_SESSION['user_name']))  and (isset($_SESSION['user_email'])) ){
       $this->classLoad = "\\App\\adms\\Controllers\\" . $this->urlController;
   }else{
   ...
   header("Location: $urlRedirect");
    ...
    private function slugController(string $slugController): string
    {
        ...
        $this->urlSlugController = strtolower($this->urlController);
        // Converter o traco para espaco em braco
        $this->urlSlugController = str_replace("-", " ", $this->urlController);
        // Converter a primeira letra de cada palavra para maiusculo
        $this->urlSlugController = ucwords($this->urlController);
  ...
  private function slugMetodo(string $urlSlugMetodo): string
    {
        ...
        $this->urlSlugMetodo = lcfirst($this->urlMetodo);
